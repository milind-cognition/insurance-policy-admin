...
/**
 * JPA entity mapped from DB2 table ACMEINS.UNDERWRITING_DECISIONS.
 * Stores the audit trail of underwriting decisions rendered by the
 * UNDWRT program (COBOL) or this modernized Java service.
 */
@Entity
