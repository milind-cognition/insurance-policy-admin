...
/**
 * Holds the INSERT statement for writing premium records to the PREMIUMS table.
 * Corresponds to COBOL paragraph 3300-WRITE-PREMIUM-RECORD (lines 202-218).
 */
@Repository
public class PremiumRepository {

    public static final String INSERT_PREMIUM =
