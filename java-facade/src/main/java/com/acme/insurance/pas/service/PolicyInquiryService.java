...
/**
 * Policy Inquiry Service — Java equivalent of COBOL POLQRY program.
 *
 * Replicates the POLQRY main logic flow (POLQRY.cbl lines 46-58):
 *   1000-RECEIVE-INPUT  → validate policy number
 *   2000-READ-POLICY    → fetch policy from POLICIES table
 *   3000-READ-CUSTOMER  → fetch customer from POLICY_HOLDERS table
 *   4000-READ-COVERAGES → fetch coverages from COVERAGES table (max 20)
